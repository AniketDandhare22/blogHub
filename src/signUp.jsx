          ...
          <div className="mt-3 w-full p-8 lg:p-30 md:p-20 mx-3 sm:mx-1">
              ...
              <div className="flex flex-col justify-center items-center gap-4 w-full">
                ...
                <div className="flex gap-4">
                  {["google", "facebook", "linkedin"].map((icon) => (
                    <button
                      key={icon}
                      className={`p-3 bg-white border-2 border-transparent rounded-full ${status?"hover:border-purple-900":" hover:border-orange-500"} transition duration-400`}
                    >
                      <img
                ...
                <button className={`px-3 p-2 bg-white text-black rounded-lg hover:scale-97 active:scale-95 active:font-bold`} onClick={() => toggleTheme()}>{!dark ? "Mode-Light" : "Mode-Dark"}</button>
              </div>
            </div>
        </div>
      </div>
